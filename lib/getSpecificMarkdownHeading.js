...
2. List is wikiEmbeds objects with a link and heading keys
3. Content is the raw markdown from the path of the markdown file

#TODO Why do we read the markdown file from the file 
system and as an input to the function?

#TODO If we want this to be modular we need to have the 
wikiembeds and content and output the content, no file system stuff
...
export async function addInEmbeddedNotes2(content, wikiEmbeds) {
  let raw_links = []
